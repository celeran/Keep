...
import com.k1odev.keep.model.Note
import com.k1odev.keep.recyclerview.NoteAdapter
import com.k1odev.keep.utils.loadNotes
import com.k1odev.keep.utils.persistNote
...
//        snackbar.anchorView = addNote_fab
    ...
    private fun deleteNote(noteIndex: Int) {
        if (noteIndex == -1) {
            ...
            com.k1odev.keep.utils.deleteNote(this, note)
            noteAdapter.notifyDataSetChanged()
            deleteSnackbar()
        }
    }
